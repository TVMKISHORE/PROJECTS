...
X_train$Product_Category_2[is.na(X_train$Product_Category_2)] <- 99
X_train$Product_Category_3[is.na(X_train$Product_Category_3)] <- 99
#---------------------------------------------------------------
# Building Model: GBM
#---------------------------------------------------------------
...
#data to h2o cluster
train.h2o <- as.h2o(X_train)
test.h2o <- as.h2o(X_test)
...
summary(train.h2o)
train.h20=as.h2o(cbind(train.h2o,y.h2o))
