...
train <- read.csv("C:/Users/Admin/Downloads/Loan_prediction/train_u6lujuX_CVtuZ9i.csv", na.strings=c("","NA"))
train_nona=train[complete.cases(train),]
train_na=train[!complete.cases(train),]

#Load test data
#To replace all the spaces and nulls as NA while loading
test <- read.csv("C:/Users/Admin/Downloads/Loan_prediction/test_Y3wMUE5_7gLdaTN.csv", na.strings=c("","NA"))
test_nona=test[complete.cases(test),]
test_na=test[!complete.cases(test),]


#---------------------------
# cobbining tets and train set for imputation 
#---------------------------
...
total_data=rbind(train[cols],test[cols],axis=1)
#impute the data
...
what_tolook=0   #index
#what_togettst=c("Loan_ID","ApplicantIncome.y","CoapplicantIncome.y","LoanAmount.y","Loan_Amount_Term.y","Credit_History.y")
what_togettst=c("Loan_ID","ApplicantIncome.y","CoapplicantIncome.y","LoanAmount.y","Loan_Amount_Term.y","Credit_History.x")
what_togettrn=c("ApplicantIncome.y","CoapplicantIncome.y","LoanAmount.y","Loan_Amount_Term.y","Credit_History.y","Loan_Status")
what_togettrn_rename=c("ApplicantIncome","CoapplicantIncome","LoanAmount","Loan_Amount_Term","Credit_History","Loan_Status")
what_togettst_rename=c("Loan_ID","ApplicantIncome","CoapplicantIncome","LoanAmount","Loan_Amount_Term","Credit_History")
trainf1=lookup_table(train,dataset1,what_tolook,what_togettrn)
testf1=lookup_table(test,dataset1,what_tolook,what_togettst)
...
trainf1=lookup_table(train,dataset4,what_tolook,what_togettrn)
...
write.csv(trainf1,file='trainf1.csv')
